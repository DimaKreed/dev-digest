...
- [Eval Pipeline — a regression harness for reviewer agents](./04-eval-pipeline.md) — accept/dismiss decisions become eval cases in one click, an agent runs its whole set over frozen inputs, and recall/precision/citation accuracy are scored entirely in code
