...
A spec covers: the screens and routes involved, states (loading / empty / error / success),
interactions, and what "done" means. It does not cover component structure — that's the
code, and the reasoning behind it goes in [../docs/](../docs/).
