...
/* Only routes that exist are listed. A nav entry pointing at an unbuilt page is
   a dead link in the sidebar AND a dead entry in the command palette (which is
   generated from this list), so later lessons add their own items here. */
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: "onboarding-tour", label: "Onboarding Tour", icon: "Lightbulb", href: "/repos/:repoId/onboarding", gKey: "o" },
    ],
  },
  {
    section: "SKILLS LAB",
